#' fetch_shopifyads
#' A function to fetch Shopify Ads data from the windsor.ai API
#'
...
#' @examples
#' \dontrun{
#' my_shopifyads_data <- fetch_shopifyads(api_key = "your api key",
...
fetch_shopifyads <-
  function(api_key,
    ...
    json_data <- jsonlite::fromJSON(
      paste0(
        "https://connectors.windsor.ai/shopify?api_key=",
        api_key,
        "&fields=",
